...
public class OnGetDocumentMeta {
    ...
    public void handle(OnSendDocumentRequestToQueue event) throws JsonProcessingException {
        ...
        properties.setReplyTo("metaReplyQueue"); // Explicitly set reply queue
        properties.setHeader("__TypeId__", DocumentMetaRequest.class.getName()); // Tell RabbitMQ the type
